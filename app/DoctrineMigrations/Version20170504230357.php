 ...
 */
class Version20170504230357 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME DEFAULT NULL, name VARCHAR(150) DEFAULT NULL, link VARCHAR(250) NOT NULL, avatar VARCHAR(250) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
